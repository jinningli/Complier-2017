...
//Define Local Variable
    ...
    long __tmp7_22_;
//Function Body
    fputs((char*)(toMoStr("start")), stderr);
    ;
    __tmp0_16_ = getString();
    __tmp1_18_ = parseInt((__tmp0_16_));
    n_ = (__tmp1_18_);
    __tmp2_17_ = toString((n_));
    fputs((char*)(__tmp2_17_), stderr);
    ;
    __tmp4_13_ = (n_);
    __tmp3_14_ = __lib_malloc((((__tmp4_13_) * (8)) + (8)));
    *((long*)(__tmp3_14_)) = (__tmp4_13_);
    __tmp3_14_ = ((__tmp3_14_) + (8));
    a_ = (__tmp3_14_);
    i_19_ = (0);
    AsmLabel33:;
    __tmp6_20_ = size((a_));
    if(((i_19_) < (__tmp6_20_))) goto AsmLabel34; else goto AsmLabel36;;
    AsmLabel34:;
    *((long*)((a_) + ((i_19_) * (8)))) = (i_19_);
    AsmLabel35:;
    i_19_ = ((i_19_) + (1));
    goto AsmLabel33;
    AsmLabel36:;
    makeHeap();
    ;
    fputs((char*)(toMoStr("heap")), stderr);

    ;
    heapSort();
    ;
    fputs((char*)(toMoStr("sort")), stderr);
    ;
    i_19_ = (0);
    AsmLabel37:;
    __tmp7_22_ = size((a_));
    if(((i_19_) < (__tmp7_22_))) goto AsmLabel38; else goto AsmLabel40;;
    AsmLabel38:;
    __tmp8_21_ = toString((*(long *)((a_) + ((i_19_) * (8)))));
    print(str_add((__tmp8_21_), (toMoStr(" "))));
    ;
    AsmLabel39:;
    i_19_ = ((i_19_) + (1));
    goto AsmLabel37;
