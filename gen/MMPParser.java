...
public class MMPParser extends Parser {
	...
	public static final int
		...
		T__9=10, T__10=11, T__11=12, INT=13, BOOL=14, NULL=15, STRING=16, ID=17, 
		IF=18, ELSE=19, ELSEIF=20, WHILE=21, FOR=22, CONTINUE=23, BREAK=24, RETURN=25, 
		VOID=26, PLUS=27, MINUS=28, MUL=29, DIV=30, MOD=31, LESS=32, LARGE=33, 
		EQ=34, NEQ=35, LESSEQ=36, LARGEEQ=37, PLUSPLUS=38, MINUSMINUS=39, DOT=40, 
		AND=41, OR=42, NOT=43, BAND=44, BOR=45, BNOT=46, BXOR=47, BMOV_L=48, BMOV_R=49, 
	...
	private static final String[] _SYMBOLIC_NAMES = {
		...
		null, "INT", "BOOL", "NULL", "STRING", "ID", "IF", "ELSE", "ELSEIF", "WHILE", 
		"FOR", "CONTINUE", "BREAK", "RETURN", "VOID", "PLUS", "MINUS", "MUL", 
	...
	public MMPParser(TokenStream input) {
		super(input);
		_interp = new ParserATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}
	public static class ProgramContext extends ParserRuleContext {
		public TerminalNode EOF() { return getToken(MMPParser.EOF, 0); }
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__2) | (1L << INT) | (1L << BOOL) | (1L << STRING) | (1L << ID) | (1L << VOID))) != 0)) {
				{
				{
				setState(32);
				decl();
	...
	public static class VarDeclContext extends ParserRuleContext {
		...
		public TerminalNode ID() { return getToken(MMPParser.ID, 0); }
	...
	public static class FuncDeclContext extends ParserRuleContext {
		public List<TerminalNode> ID() { return getTokens(MMPParser.ID); }
		public TerminalNode ID(int i) {
			return getToken(MMPParser.ID, i);
		}
		...
		public TerminalNode VOID() { return getToken(MMPParser.VOID, 0); }
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << T__3) | (1L << T__6) | (1L << T__8) | (1L << INT) | (1L << BOOL) | (1L << NULL) | (1L << STRING) | (1L << ID) | (1L << IF) | (1L << WHILE) | (1L << FOR) | (1L << CONTINUE) | (1L << BREAK) | (1L << RETURN) | (1L << PLUS) | (1L << MINUS) | (1L << PLUSPLUS) | (1L << MINUSMINUS) | (1L << NOT) | (1L << BNOT))) != 0)) {
				{
				{
				setState(90);
				stmt();
	...
	public final ClassBlockContext classBlock() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << INT) | (1L << BOOL) | (1L << STRING) | (1L << ID) | (1L << VOID))) != 0)) {
				{
				setState(101);
				_errHandler.sync(this);
	...
	public static class ControlStatementContext extends StmtContext {
		...
		public TerminalNode RETURN() { return getToken(MMPParser.RETURN, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public TerminalNode BREAK() { return getToken(MMPParser.BREAK, 0); }
		public TerminalNode CONTINUE() { return getToken(MMPParser.CONTINUE, 0); }
	...
	public static class IfStmtContext extends ParserRuleContext {
		public TerminalNode IF() { return getToken(MMPParser.IF, 0); }
		...
		public TerminalNode ELSE() { return getToken(MMPParser.ELSE, 0); }
		public List<TerminalNode> ELSEIF() { return getTokens(MMPParser.ELSEIF); }
		public TerminalNode ELSEIF(int i) {
			return getToken(MMPParser.ELSEIF, i);
		}
	...
	public static class ForStmtContext extends ParserRuleContext {
		public TerminalNode FOR() { return getToken(MMPParser.FOR, 0); }
	...
	public static class WhileStmtContext extends ParserRuleContext {
		public TerminalNode WHILE() { return getToken(MMPParser.WHILE, 0); }
	...
	public static class BinaryBitOperationContext extends ExprContext {
		...
		public TerminalNode BAND() { return getToken(MMPParser.BAND, 0); }
		public TerminalNode BXOR() { return getToken(MMPParser.BXOR, 0); }
		public TerminalNode BOR() { return getToken(MMPParser.BOR, 0); }
	...
	public static class SignExpressionContext extends ExprContext {
		...
		public TerminalNode MINUS() { return getToken(MMPParser.MINUS, 0); }
		public TerminalNode PLUS() { return getToken(MMPParser.PLUS, 0); }
	...
	public static class BinaryBitMovContext extends ExprContext {
		...
		public TerminalNode BMOV_L() { return getToken(MMPParser.BMOV_L, 0); }
		public TerminalNode BMOV_R() { return getToken(MMPParser.BMOV_R, 0); }
	...
	public static class BitNotOperationContext extends ExprContext {
		public TerminalNode BNOT() { return getToken(MMPParser.BNOT, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
	...
	public static class NotOperationContext extends ExprContext {
		public TerminalNode NOT() { return getToken(MMPParser.NOT, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
	...
	public static class PostSelfOpContext extends ExprContext {
		...
		public TerminalNode PLUSPLUS() { return getToken(MMPParser.PLUSPLUS, 0); }
		public TerminalNode MINUSMINUS() { return getToken(MMPParser.MINUSMINUS, 0); }
	...
	public static class BinaryExpressionContext extends ExprContext {
		...
		public TerminalNode PLUS() { return getToken(MMPParser.PLUS, 0); }
		public TerminalNode MINUS() { return getToken(MMPParser.MINUS, 0); }
		public TerminalNode MUL() { return getToken(MMPParser.MUL, 0); }
		public TerminalNode DIV() { return getToken(MMPParser.DIV, 0); }
		public TerminalNode MOD() { return getToken(MMPParser.MOD, 0); }
	...
	public static class LogicExpressionContext extends ExprContext {
		...
		public TerminalNode LESS() { return getToken(MMPParser.LESS, 0); }
		public TerminalNode LARGE() { return getToken(MMPParser.LARGE, 0); }
		public TerminalNode LESSEQ() { return getToken(MMPParser.LESSEQ, 0); }
		public TerminalNode LARGEEQ() { return getToken(MMPParser.LARGEEQ, 0); }
		public TerminalNode EQ() { return getToken(MMPParser.EQ, 0); }
		public TerminalNode NEQ() { return getToken(MMPParser.NEQ, 0); }
		public TerminalNode AND() { return getToken(MMPParser.AND, 0); }
		public TerminalNode OR() { return getToken(MMPParser.OR, 0); }
	...
	public static class CallMemberContext extends ExprContext {
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public TerminalNode DOT() { return getToken(MMPParser.DOT, 0); }
		public TerminalNode ID() { return getToken(MMPParser.ID, 0); }
	...
	public static class ExpressionListContext extends ExprContext {
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		public ExprContext expr(int i) {
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 9:
						{
						_localctx = new ExpressionListContext(new ExprContext(_parentctx, _parentState));
						pushNewRecursionContext(_localctx, _startState, RULE_expr);
						setState(213);
					...
					case 10:
						{
						_localctx = new CallMemberContext(new ExprContext(_parentctx, _parentState));
						pushNewRecursionContext(_localctx, _startState, RULE_expr);
						setState(226);
	...
	public static class TypeContext extends ParserRuleContext {
		public TerminalNode BOOL() { return getToken(MMPParser.BOOL, 0); }
		public TerminalNode INT() { return getToken(MMPParser.INT, 0); }
		public TerminalNode STRING() { return getToken(MMPParser.STRING, 0); }
		public TerminalNode ID() { return getToken(MMPParser.ID, 0); }
	...
	public static class ConstantContext extends ParserRuleContext {
		public TerminalNode NULL() { return getToken(MMPParser.NULL, 0); }
		public TerminalNode INT() { return getToken(MMPParser.INT, 0); }
		public TerminalNode STRING() { return getToken(MMPParser.STRING, 0); }
		public TerminalNode BOOL() { return getToken(MMPParser.BOOL, 0); }
	...
	public static final String _serializedATN =
		...
		"\3\16\3\16\3\16\3\16\3\16\3\16\3\16\3\16\7\16\u00f4\n\16\f\16\16\16\u00f7"+
		"\13\16\3\16\3\16\3\16\3\16\3\16\3\16\3\16\3\16\3\16\7\16\u0102\n\16\f"+
		"\16\16\16\u0105\13\16\3\17\3\17\3\20\7\20\u010a\n\20\f\20\16\20\u010d"+
		"\13\20\3\21\3\21\3\21\3\u010b\3\32\22\2\4\6\b\n\f\16\20\22\24\26\30\32"+
		"\34