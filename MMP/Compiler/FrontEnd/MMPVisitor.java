...
public interface MMPVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitMemberFunction(MMPParser.MemberFunctionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitFunctionCall(MMPParser.FunctionCallContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitMember(MMPParser.MemberContext ctx);
	/**
