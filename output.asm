...
___lib_printlnInt:; Function begin
        ...
        lea     rax, [rel ___lib_printlnInt+204H]       ; 0008 _ 48: 8D. 05, 00000204(rel)
...
___lib_printInt:; Function begin
        ...
        lea     rax, [rel ___lib_printlnInt+1D9H]       ; 0038 _ 48: 8D. 05, 000001D9(rel)
...
_main:  ; Function begin
        ...
        sub     rsp, 16                                 ; 01F4 _ 48: 83. EC, 10
        lea     rdi, [rel ___lib_printlnInt+1DH]        ; 01F8 _ 48: 8D. 3D, 0000001D(rel)
        mov     dword [rbp-4H], 0                       ; 01FF _ C7. 45, FC, 00000000
        call    _println                                ; 0206 _ E8, 00000000(rel)
        xor     eax, eax                                ; 020B _ 31. C0
        add     rsp, 16                                 ; 020D _ 48: 83. C4, 10
        pop     rbp                                     ; 0211 _ 5D
        ret                                             ; 0212 _ C3
...
SECTION ._TEXT.__cstring align=1 noexecute              ; section number 2, data
        ...
        db 25H, 6CH, 64H, 0AH, 00H, 25H, 6CH, 64H       ; 0213 _ %ld..%ld
        db 00H, 48H, 65H, 6CH, 6CH, 6FH, 2CH, 20H       ; 021B _ .Hello, 
        db 77H, 6FH, 72H, 6CH, 64H, 21H, 00H            ; 0223 _ world!.
